...
// คิวรีตอนนี้ตื้นหมดแล้ว (หั่นก้อน) — ตัวที่พลาดมี retry รองรับ
// ⚠️ 18 ทำ apiSales ช่วงยาววิ่งเกิน 300s (statement timeout ระบาดแล้ว retry ทบเวลา) — 12 คือจุดสมดุลที่วัดแล้ว
